...
describe('getFamilyProvider', () => {
  it('resolves the dedicated non-EVM providers', () => {
    ...
    expect(getFamilyProvider('sui')?.name).toBe('sui')
    expect(getFamilyProvider('stellar')?.name).toBe('stellar')
    expect(getFamilyProvider('hedera')?.name).toBe('hedera')
    expect(getFamilyProvider('bitcoincash')?.name).toBe('bitcoincash')
